    ...
    <section className="bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="placeholder-grid relative aspect-[4/3] overflow-hidden rounded-2xl">
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="rounded-md bg-white/80 px-3 py-1 text-[10px] font-medium uppercase tracking-wider text-[#6b7280]">
                Team Photo
              </span>
            </div>
            <div className="absolute bottom-4 left-4 flex items-center gap-3 rounded-xl bg-[#1a1a1a]/90 px-4 py-3 backdrop-blur-sm">
          ...
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-extrabold tracking-tight text-[#1a1a1a] sm:text-4xl">
              ...
              <span className="text-[#c8102e]">Excellence</span>
            </h2>
