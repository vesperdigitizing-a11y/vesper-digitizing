  ...
  return (
    <>
      ...
      <main className="flex-1">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <ScrollReveal delay={100}>
                <h1 className="mt-5 font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-[#1a1a1a] sm:text-5xl lg:text-6xl">
                  Patches That <span className="text-gradient">Stand Out</span>
                </h1>
              </ScrollReveal>
        ...
        {/* ============ PATCH TYPES - WITH TILTCARD & PLUS ICON ============ */}
        <section id="types" className="bg-[#f5f5f5] py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                eyebrow="Patch Types"
                title="Every Patch Style Imaginable"
                subtitle="Choose the construction that fits your design, garment, and budget. We'll guide you to the right pick."
              />
            </ScrollReveal>
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div>
                <ScrollReveal>
                  <SectionHeading
                    align="left"
                    eyebrow="Backing Options"
                    title="How Will You Attach It?"
                    subtitle="Every patch comes with your choice of backing."
                  />
                </ScrollReveal>
              ...
              <div>
                <ScrollReveal>
                  <SectionHeading
                    ...
                    subtitle="From tiny collar patches to oversized back banners."
                  />
                </ScrollReveal>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                ...
                subtitle="A streamlined five-step workflow that turns your artwork into production-ready patch files."
              />
            </ScrollReveal>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                ...
                title="The Patch Experts"
                subtitle="We've digitized thousands of patches for brands, teams, military, and businesses worldwide."
                light
              />
            </ScrollReveal>
