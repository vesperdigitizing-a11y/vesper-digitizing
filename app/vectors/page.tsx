          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <ScrollReveal delay={100}>
                <h1 className="mt-5 font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-[#1a1a1a] sm:text-5xl lg:text-6xl">
                  Vectors That <span className="text-gradient">Never Pixelate</span>
                </h1>
              </ScrollReveal>
              ...
              <ScrollReveal delay={200}>
                <p className="mt-5 text-base leading-relaxed text-[#6b7280] sm:text-lg">
                  ...
                  losing quality. Delivered in your preferred format.
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={300}>
                <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                  <a
                    href="#quote"
                    className="inline-flex h-12 items-center justify-center gap-2 rounded-md bg-[#c8102e] px-7 text-sm font-semibold text-white shadow-lg transition-all hover:scale-105 hover:bg-[#a30d24]"
                  >
                    Get Free Quote
                  </a>
                  <a
                    href="#types"
                    className="inline-flex h-12 items-center justify-center gap-2 rounded-md border border-[#e5e7eb] bg-white px-7 text-sm font-semibold text-[#1a1a1a] transition-all hover:scale-105 hover:border-[#c8102e] hover:text-[#c8102e]"
                  >
                    Explore Vector Services
                  </a>
                </div>
              </ScrollReveal>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                ...
                title="Every Vector Conversion Need"
                subtitle="From simple logos to complex illustrations — we deliver print-ready, scalable vector files."
              />
            </ScrollReveal>
              ...
              <div>
                <ScrollReveal>
                  <SectionHeading
                    ...
                    title="Delivered In Your Format"
                    subtitle="Every vector is delivered in all formats — no extra charge."
                  />
                </ScrollReveal>

                <ScrollReveal stagger className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
                  {FORMATS.map((f) => (
                    <div
                      key={f.label}
                    ...
                    >
                      <div className="font-display text-2xl font-extrabold text-[#1a1a1a] transition-colors group-hover:text-[#c8102e]">
                        {f.label}
                      </div>
              ...
              <div>
                <ScrollReveal>
                  <SectionHeading
                    align="left"
                    eyebrow="Use Cases"
                    title="Where Vectors Shine"
                    subtitle="Scalable art for every application."
                  />
                </ScrollReveal>
        ...
        <section className="bg-[#f5f5f5] py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                eyebrow="Our Process"
                title="From Pixels to Paths"
                subtitle="A streamlined five-step workflow that turns any raster image into clean, scalable vector art."
              />
            </ScrollReveal>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                ...
                subtitle="We've converted thousands of images into clean, scalable vectors for brands worldwide."
                light
              />
            </ScrollReveal>
        ...
        <section className="bg-white py-16 sm:py-24">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <ScrollReveal>
              <SectionHeading
                eyebrow="FAQ"
                title="Vector Conversion Questions"
